 ...
 * 
 */
@WebServiceClient(name = "CalculatorServiceService", targetNamespace = "http://prac.mayur.org/", wsdlLocation = "http://rishmay-pc:8080/Calc6583833343999476496/CalculatorServiceService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICESERVICE_QNAME = new QName("http://prac.mayur.org/", "CalculatorServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://rishmay-pc:8080/Calc6583833343999476496/CalculatorServiceService?wsdl");
    ...
    public CalculatorService getCalculatorServicePort() {
        return super.getPort(new QName("http://prac.mayur.org/", "CalculatorServicePort"), CalculatorService.class);
    }
    ...
    public CalculatorService getCalculatorServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://prac.mayur.org/", "CalculatorServicePort"), CalculatorService.class, features);
    }
